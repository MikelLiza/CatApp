...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { age: @cat.age, breed: @cat.breed, name: @cat.name, owner_email: @cat.owner_email } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { age: @cat.age, breed: @cat.breed, name: @cat.name, owner_email: @cat.owner_email } }
